...
CONTAINS
  ...
  SUBROUTINE READCL(LAMBDA, SEEDI, N, FIL, IDIST, EPS, SCAL, INFO)
    ...
    IF (COMMAND_ARGUMENT_COUNT() .LT. NRQP) THEN
       WRITE (OUTPUT_UNIT,*) 'dgenevd.exe LAMBDA SEEDIX N FILE [ LAMBDA_PARAMS ]'
       ...
       WRITE (OUTPUT_UNIT,*) 'FILE.A  : double precision(N,N); a symmetric matrix A'
