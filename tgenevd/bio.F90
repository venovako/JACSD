...
2   WRITE (ERROR_UNIT,'(2A)') 'BIO_CLOSE   :', TRIM(MSG)
  ...
  SUBROUTINE BIO_WRITE_S1(U, N, A, INFO)
    ...
    RETURN
3   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_S1:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
...
4   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_D1:', TRIM(MSG)
  ...
  SUBROUTINE BIO_WRITE_S2(U, M, N, A, INFO)
    ...
    RETURN
5   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_S2:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
...
6   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_D2:', TRIM(MSG)
  ...
  SUBROUTINE BIO_WRITE_C2(U, M, N, A, INFO)
    ...
    WRITE (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=7) A
    RETURN
7   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_C2:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
...
8   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_Z2:', TRIM(MSG)
  ...
  SUBROUTINE BIO_READ_S1(U, N, A, INFO)
    ...
    RETURN
9   WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_S1 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_READ_D1(U, N, A, INFO)
    ...
    RETURN
10  WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_D1 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
