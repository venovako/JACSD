...
CONTAINS
  ...
  SUBROUTINE SCLCSD(M, P, Q, X, LDX, THETA, C, S, U, LDU, VT, LDVT, INFO)
    ...
    INTEGER, INTRINSIC :: CEILING, MIN, MAX
    REAL, INTRINSIC :: REAL !, COS, SIN
...
!           S(I) = SIN(THETA(I))
  ...
  SUBROUTINE STXCSD(M, P, Q, NT, FN, RN, INFO)
    ...
    INTEGER, INTRINSIC :: LEN_TRIM, MIN, MAX
#ifndef USE_ESSL
    EXTERNAL :: SLASET
#endif
  ...
  SUBROUTINE DCLCSD(M, P, Q, X, LDX, THETA, C, S, U, LDU, VT, LDVT, INFO)
    ...
    INTEGER, INTRINSIC :: CEILING, MIN, MAX
    DOUBLE PRECISION, INTRINSIC :: DBLE !, COS, SIN
...
!           S(I) = SIN(THETA(I))
  ...
  SUBROUTINE CCLCSD(M, P, Q, X, LDX, THETA, C, S, U, LDU, VT, LDVT, INFO)
    ...
    INTEGER, INTRINSIC :: CEILING, MIN, MAX
    REAL, INTRINSIC :: AIMAG, REAL
    COMPLEX, INTRINSIC :: COS, SIN
  ...
  SUBROUTINE ZCLCSD(M, P, Q, X, LDX, THETA, C, S, U, LDU, VT, LDVT, INFO)
    ...
    INTEGER, INTRINSIC :: CEILING, MIN, MAX
    DOUBLE PRECISION, INTRINSIC :: AIMAG, DBLE
    DOUBLE COMPLEX, INTRINSIC :: COS, SIN
