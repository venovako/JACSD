...
SUBROUTINE MYDJAC1(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR, NBSIZE, NBSIZ2, LDAC, NPAIRS, NBL, JSTRAT, TOL,&
  ...
  I = MAXTHR * NPAIRS
  BLASNT = BLAS_SET_NUM_THREADS(I)
  CALL DLASET('A', N, N, D_ZERO, D_ONE, V, LDV) ! V = I_N
  J = BLAS_SET_NUM_THREADS(MAXTHR)
  ...
  DO CYC = 1, MAXCYC(1)
     ...
     DO STP = 1, STEPS
        ...
        !$OMP PARALLEL DO NUM_THREADS(NPAIRS), PRIVATE(PAIR,I,J,NC1,IFC1,NC2,IFC2,G0I,G1I,V0I,V1I,G0J,G1J,V0J,V1J)
        DO PAIR = 1, NPAIRS
...
9 BLASNT = BLAS_SET_NUM_THREADS(BLASNT)
...
2 CONTINUE
  ...
  IF ((INFO(1) .EQ. 0) .AND. (.NOT. FAST)) THEN
     ...
     BLASNT = BLAS_SET_NUM_THREADS(MAXTHR(2))
     !$OMP DO
     DO J = 1, N
