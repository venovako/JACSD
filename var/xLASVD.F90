...
#ifdef SLASVD
  REAL(RWP), ALLOCATABLE :: A(:,:), U(:,:), V(:,:), SVA(:)
...
#endif
#ifdef DLASVD
  REAL(DWP), ALLOCATABLE :: A(:,:), U(:,:), V(:,:), SVA(:)
  !DIR$ ATTRIBUTES ALIGN: MALIGN_B:: A,U,V,SVA
...
#endif
#ifdef CLASVD
  COMPLEX(RWP), ALLOCATABLE :: A(:,:), U(:,:), V(:,:)
  REAL(RWP), ALLOCATABLE :: SVA(:)
  !DIR$ ATTRIBUTES ALIGN: MALIGN_B:: A,U,V,SVA
...
#endif
#ifdef ZLASVD
  COMPLEX(DWP), ALLOCATABLE :: A(:,:), U(:,:), V(:,:)
  REAL(DWP), ALLOCATABLE :: SVA(:)
  !DIR$ ATTRIBUTES ALIGN: MALIGN_B:: A,U,V,SVA
...
#endif
#ifdef CLASVD
  COMPLEX(RWP), ALLOCATABLE :: A(:,:), U(:,:), VT(:,:)
  REAL(RWP), ALLOCATABLE :: S(:)
  !DIR$ ATTRIBUTES ALIGN: MALIGN_B:: A,U,VT,S
  COMPLEX(RWP), ALLOCATABLE :: WORK(:)
  REAL(RWP), ALLOCATABLE :: RWORK(:)
#ifdef FW
...
#endif
#ifdef ZLASVD
  COMPLEX(DWP), ALLOCATABLE :: A(:,:), U(:,:), VT(:,:)
  REAL(DWP), ALLOCATABLE :: S(:)
  !DIR$ ATTRIBUTES ALIGN: MALIGN_B:: A,U,VT,S
  COMPLEX(DWP), ALLOCATABLE :: WORK(:)
  REAL(DWP), ALLOCATABLE :: RWORK(:)
#ifdef FW
...
#undef REALSVD
  ...
  INFO = 0
  IF (BLAS_PREPARE(.FALSE., .TRUE.) .LT. 1) STOP 'BLAS_PREPARE'
  ...
  CALL BIN_READ_2(IOU, LDA, A, M, N, INFO)
  IF (INFO .NE. 0) STOP 'BIN_READ_2(F)'
  ...
  IF (BLAS_FINISH() .LT. 0) STOP 'BLAS_FINISH'
...
CONTAINS
  ...
  SUBROUTINE READCL(JOBA, JOBU, JOBV, JOBR, JOBT, JOBP, M, N, LDA, LDU, LDV, F, INFO)
    ...
    ELSE
#ifdef SLASVD
       WRITE (*,*) 'SGEJSV.exe JOBA JOBU JOBV JOBR JOBT JOBP M N LDA LDU LDV F'
#endif
#ifdef DLASVD
       WRITE (*,*) 'DGEJSV.exe JOBA JOBU JOBV JOBR JOBT JOBP M N LDA LDU LDV F'
#endif
#ifdef CLASVD
       WRITE (*,*) 'CGEJSV.exe JOBA JOBU JOBV JOBR JOBT JOBP M N LDA LDU LDV F'
#endif
#ifdef ZLASVD
       WRITE (*,*) 'ZGEJSV.exe JOBA JOBU JOBV JOBR JOBT JOBP M N LDA LDU LDV F'
#endif
    END IF
    INFO = INFO - 13
  ...
  SUBROUTINE READCL(JOBA, JOBU, JOBV, M, N, LDA, MV, LDV, F, INFO)
    ...
    ELSE
#ifdef SLASVD
       WRITE (*,*) 'SGESVJ.exe JOBA JOBU JOBV M N LDA MV LDV F'
#endif
#ifdef DLASVD
       WRITE (*,*) 'DGESVJ.exe JOBA JOBU JOBV M N LDA MV LDV F'
#endif
#ifdef CLASVD
       WRITE (*,*) 'CGESVJ.exe JOBA JOBU JOBV M N LDA MV LDV F'
#endif
#ifdef ZLASVD
       WRITE (*,*) 'ZGESVJ.exe JOBA JOBU JOBV M N LDA MV LDV F'
#endif
    END IF
    INFO = INFO - 9
  END SUBROUTINE READCL
  ...
  SUBROUTINE READCL(JOBU, JOBVT, M, N, LDA, LDU, LDVT, F, INFO)
    ...
    ELSE
#ifdef SLASVD
       WRITE (*,*) 'SGESVD.exe JOBU JOBVT M N LDA LDU LDVT F'
#endif
#ifdef DLASVD
       WRITE (*,*) 'DGESVD.exe JOBU JOBVT M N LDA LDU LDVT F'
#endif
#ifdef CLASVD
       WRITE (*,*) 'CGESVD.exe JOBU JOBVT M N LDA LDU LDVT F'
#endif
#ifdef ZLASVD
       WRITE (*,*) 'ZGESVD.exe JOBU JOBVT M N LDA LDU LDVT F'
#endif
    END IF
    INFO = INFO - 8
  END SUBROUTINE READCL
  ...
  SUBROUTINE READCL(JOBZ, M, N, LDA, LDU, LDVT, F, INFO)
    ...
    ELSE
#ifdef SLASVD
       WRITE (*,*) 'SGESDD.exe JOBZ M N LDA LDU LDVT F'
#endif
#ifdef DLASVD
       WRITE (*,*) 'DGESDD.exe JOBZ M N LDA LDU LDVT F'
#endif
#ifdef CLASVD
       WRITE (*,*) 'CGESDD.exe JOBZ M N LDA LDU LDVT F'
#endif
#ifdef ZLASVD
       WRITE (*,*) 'ZGESDD.exe JOBZ M N LDA LDU LDVT F'
#endif
    END IF
    INFO = INFO - 7
  END SUBROUTINE READCL
