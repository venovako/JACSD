SUBROUTINE INVJAC1(NC1,IFC1, NC2,IFC2, M,N, G0I,G1I,G0J,G1J,LDG, V0I,V1I,V0J,V1J,LDV, NBSIZ2,LDAC,&
...
SUBROUTINE MYVJAC1(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR, NBSIZE, NBSIZ2, LDAC, NPAIRS, NBL, JSTRAT, TOL,&
  ...
  DO CYC = 1, MAXCYC(1)
     ...
     DO STP = 1, STEPS
        ...
        DO PAIR = 1, NPAIRS
           ...
           CALL INVJAC1(NC1,IFC1, NC2,IFC2, M,N, G0I,G1I,G0J,G1J,LDG, V0I,V1I,V0J,V1J,LDV, NBSIZ2,LDAC,&
...
SUBROUTINE VJAC1(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR, JSTRAT, TOL, SIGMA,&
...
2 CONTINUE
  ...
  CALL MYVJAC1(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR(2), NBSIZE, NBSIZ2, LDAC, NPAIRS, MYNBL, JSTRAT, TOL,&
