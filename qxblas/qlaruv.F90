!> \brief \b QLARUV returns a vector of n random real numbers from a uniform distribution.
!
!  =========== DOCUMENTATION ===========
!
...
!> distribution (n <= 128).
!>
!> This is an auxiliary routine called by QLARNV and XLARNV.
!> \endverbatim
!
!  Arguments:
!  ==========
