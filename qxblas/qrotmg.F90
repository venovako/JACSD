...
!> \param[in,out] SPARAM
!> \verbatim
!>          SPARAM is REAL(WP) array, dimension 5
!>     SPARAM(1)=SFLAG
!>     SPARAM(2)=SH11
!>     SPARAM(3)=SH21
!>     SPARAM(4)=SH12
...
!     .. Parameters ..
  ...
  REAL(WP), PARAMETER :: TWO = 2.0E+0_WP
  REAL(WP), PARAMETER :: ZERO = 0.0E+0_WP
!
  REAL(WP), PARAMETER :: GAM = 4096.0E+0_WP
  REAL(WP), PARAMETER :: GAMSQ = 16777216.0E+0_WP
  REAL(WP), PARAMETER :: RGAMSQ = ONE / GAMSQ !5.9604644775390625E-8_WP
!     .. Local Scalars ..
