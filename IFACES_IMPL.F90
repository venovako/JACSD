...
PURE SUBROUTINE SLACPY(UPLO, M, N, A, LDA, B, LDB)
  ...
  INTERFACE
     PURE SUBROUTINE MYSLACPY(UPLO, M, N, A, LDA, B, LDB) BIND(C,NAME='slacpy')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA, LDB
       REAL, INTENT(IN) :: A(LDA,*)
       REAL, INTENT(OUT) :: B(LDB,*)
     END SUBROUTINE MYSLACPY
  END INTERFACE

  CALL MYSLACPY(UPLO, M, N, A, LDA, B, LDB)
...
PURE SUBROUTINE DLACPY(UPLO, M, N, A, LDA, B, LDB)
  ...
  INTERFACE
     PURE SUBROUTINE MYDLACPY(UPLO, M, N, A, LDA, B, LDB) BIND(C,NAME='dlacpy')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA, LDB
       DOUBLE PRECISION, INTENT(IN) :: A(LDA,*)
       DOUBLE PRECISION, INTENT(OUT) :: B(LDB,*)
     END SUBROUTINE MYDLACPY
  END INTERFACE

  CALL MYDLACPY(UPLO, M, N, A, LDA, B, LDB)
...
PURE SUBROUTINE CLACPY(UPLO, M, N, A, LDA, B, LDB)
  ...
  INTERFACE
     PURE SUBROUTINE MYCLACPY(UPLO, M, N, A, LDA, B, LDB) BIND(C,NAME='clacpy')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA, LDB
       COMPLEX, INTENT(IN) :: A(LDA,*)
       COMPLEX, INTENT(OUT) :: B(LDB,*)
     END SUBROUTINE MYCLACPY
  END INTERFACE

  CALL MYCLACPY(UPLO, M, N, A, LDA, B, LDB)
...
PURE SUBROUTINE ZLACPY(UPLO, M, N, A, LDA, B, LDB)
  ...
  INTERFACE
     PURE SUBROUTINE MYZLACPY(UPLO, M, N, A, LDA, B, LDB) BIND(C,NAME='zlacpy')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA, LDB
       DOUBLE COMPLEX, INTENT(IN) :: A(LDA,*)
       DOUBLE COMPLEX, INTENT(OUT) :: B(LDB,*)
     END SUBROUTINE MYZLACPY
  END INTERFACE

  CALL MYZLACPY(UPLO, M, N, A, LDA, B, LDB)
...
PURE SUBROUTINE SLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
  ...
  INTERFACE
     PURE SUBROUTINE MYSLASET(UPLO, M, N, ALPHA, BETA, A, LDA) BIND(C,NAME='slaset')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA
       REAL, INTENT(IN) :: ALPHA, BETA
       REAL, INTENT(OUT) :: A(LDA,*)
     END SUBROUTINE MYSLASET
  END INTERFACE

  CALL MYSLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
...
PURE SUBROUTINE DLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
  ...
  INTERFACE
     PURE SUBROUTINE MYDLASET(UPLO, M, N, ALPHA, BETA, A, LDA) BIND(C,NAME='dlaset')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA
       DOUBLE PRECISION, INTENT(IN) :: ALPHA, BETA
       DOUBLE PRECISION, INTENT(OUT) :: A(LDA,*)
     END SUBROUTINE MYDLASET
  END INTERFACE

  CALL MYDLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
...
PURE SUBROUTINE CLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
  ...
  INTERFACE
     PURE SUBROUTINE MYCLASET(UPLO, M, N, ALPHA, BETA, A, LDA) BIND(C,NAME='claset')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA
       COMPLEX, INTENT(IN) :: ALPHA, BETA
       COMPLEX, INTENT(OUT) :: A(LDA,*)
     END SUBROUTINE MYCLASET
  END INTERFACE

  CALL MYCLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
...
PURE SUBROUTINE ZLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
  ...
  INTERFACE
     PURE SUBROUTINE MYZLASET(UPLO, M, N, ALPHA, BETA, A, LDA) BIND(C,NAME='zlaset')
       IMPLICIT NONE
       CHARACTER, INTENT(IN) :: UPLO
       INTEGER, INTENT(IN) :: M, N, LDA
       DOUBLE COMPLEX, INTENT(IN) :: ALPHA, BETA
       DOUBLE COMPLEX, INTENT(OUT) :: A(LDA,*)
     END SUBROUTINE MYZLASET
  END INTERFACE

  CALL MYZLASET(UPLO, M, N, ALPHA, BETA, A, LDA)
