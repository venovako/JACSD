SUBROUTINE INVJAC2(NC1,IFC1, NC2,IFC2, M,N, G0I,G1I,G0J,G1J,LDG, V0I,V1I,V0J,V1J,LDV, NBSIZ2,LDAC,&
  ...
  IF (INFOP(2) .EQ. 0) THEN
     ...
     IF ((NC1 .EQ. NC2) .OR. (JSTRAT(1) .LT. JSMENC)) THEN
        CALL VJAC1(MYFAST, NCF,NCF, GB,LDAC, VB,LDAC, MAXCYC,MAXTHR,JSTRAT, TOL, SIGMAP,&
     ...
     ELSE! |NC1 - NC2| = 1 (==> NCF odd ==> no parallel strategy implemented)
        ...
        CALL VJAC1(MYFAST, NCF+1,NCF+1, GB,LDAC, VB,LDAC, MAXCYC,MAXTHR,JSTRAT, TOL, SIGMAP,&
             WORK,LWORK, IWORK,LIWORK, NROTP,INFOP)
     END IF
...
SUBROUTINE MYVJAC2(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR, NBSIZE, NBSIZ2, LDAC, NPAIRS, NBL, JSTRAT, TOL,&
  ...
  DO CYC = 1, MAXCYC(1)
     ...
     DO STP = 1, STEPS
        ...
        DO PAIR = 1, NPAIRS
           ...
           CALL INVJAC2(NC1,IFC1, NC2,IFC2, M,N, G0I,G1I,G0J,G1J,LDG, V0I,V1I,V0J,V1J,LDV, NBSIZ2,LDAC,&
  ...
  !$OMP PARALLEL NUM_THREADS(NPAIRS), PRIVATE(BLASNT,I,J)
  BLASNT = BLAS_SET_NUM_THREADS(MAXTHR(2))
  IF (.NOT. FAST) THEN
     !$OMP DO
     DO I = 1, NBL
...
SUBROUTINE VJAC2(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR, JSTRAT, TOL, SIGMA,&
...
2 CONTINUE
  ...
  IF (N .EQ. 1) THEN
     CALL VJAC1(FAST, M, N, G, LDG, V, LDV, MAXCYC(2), MAXTHR(2), JSTRAT(2), TOL, SIGMA,&
  ...
  CALL MYVJAC2(FAST, M, N, G, LDG, V, LDV, MAXCYC, MAXTHR, NBSIZE, NBSIZ2, LDAC, NPAIRS, MYNBL, JSTRAT, TOL,&
