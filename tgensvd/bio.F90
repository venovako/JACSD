...
9   WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_Q1 :', TRIM(MSG)
  ...
  SUBROUTINE BIO_READ_S1(U, N, A, INFO)
    ...
    READ (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=10) A
    RETURN
10  WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_S1 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_WRITE_S1(U, N, A, INFO)
    ...
    WRITE (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=11) A
    RETURN
11  WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_S1:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_READ_S2(U, M, N, A, INFO)
    ...
    READ (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=12) A
    RETURN
12  WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_S2 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_WRITE_S2(U, M, N, A, INFO)
    ...
    WRITE (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=13) A
    RETURN
13  WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_S2:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_READ_C2(U, M, N, A, INFO)
    ...
    READ (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=14) A
    RETURN
14  WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_C2 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_WRITE_C2(U, M, N, A, INFO)
    ...
    WRITE (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=15) A
    RETURN
15  WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_C2:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
