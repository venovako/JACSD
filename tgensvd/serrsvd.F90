...
CONTAINS
  ...
  SUBROUTINE READCL(M, N, FNG, FNU, FNS, FNV, INFO)
    ...
    INFO = 0
    IF (COMMAND_ARGUMENT_COUNT() .NE. 6) ERROR STOP 'serrsvd.exe M N FNG FNU FNS FNV'
